...
write.list(z=myTables,file="wordinitial_PG_table_12.csv",row.names=T)
...
write.list(z=myTables,file="wordinitial_GP_table_12.csv",row.names=T)
...
write.list(z=myTables,file="wordinitial_FREQ_table_12.csv",row.names=T)
...
write.list(z=myTables,file="syllableinitial_PG_table_12.csv",row.names=T)
...
write.list(z=myTables,file="syllableinitial_GP_table_12.csv",row.names=T)
...
write.list(z=myTables,file="syllableinitial_FREQ_table_12.csv",row.names=T)
...
write.list(z=myTables,file="syllablemedial_PG_table_12.csv",row.names=T)
...
write.list(z=myTables,file="syllablemedial_GP_table_12.csv",row.names=T)
...
write.list(z=myTables,file="syllablemedial_FREQ_table_12.csv",row.names=T)
...
write.list(z=myTables,file="syllablefinal_PG_table_12.csv",row.names=T)
##FOR G-P TABLES
...
write.list(z=myTables,file="syllablefinal_GP_table_12.csv",row.names=T)
...
write.list(z=myTables,file="syllablefinal_FREQ_table_12.csv",row.names=T)
...
write.list(z=myTables,file="wordfinal_PG_table_12.csv",row.names=T)
##FOR G-P TABLES
...
write.list(z=myTables,file="wordfinal_GP_table_12.csv",row.names=T)
...
write.list(z=myTables,file="wordfinal_FREQ_table_12.csv",row.names=T)
```
